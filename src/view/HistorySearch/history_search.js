...
class HistorySearch extends React.Component {
  ...
  componentDidMount() {
    ...
    this.routerPermission = this.props.location.state.list;
  ...
  legendSearchGo = (value) => {
    ...
    if (value && value.name) {
        history.push({
            pathname: '/',
            state: Object.assign({searchType: 'Legend'}, value)
        });
    }
  };
        ...
        <div className="search-legend-bd grey-sm">
          ...
          <div className="historyTitle">
            ...
            <div className="rightContainer" onClick={() => this.clearHistory()}>
              {/*<img alt="" className="ImageSize" src={require("../../assets/image/icon_clear.png")} />*/}
                ...
                return (
                  <li key={index} className="singleShowStyle">
                    ...
                    <div className="RightStyle">
                      ...
                      <div className="imageContainer" onClick={() => this.shareCurrentData(item,index)}>
